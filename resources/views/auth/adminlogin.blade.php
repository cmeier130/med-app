<x-guest-layout>
    ...
    <x-jet-authentication-card>
        <x-slot name="logo">
            <h1 class="text-center mb-4 text-2xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">管理者ログイン</span> 
