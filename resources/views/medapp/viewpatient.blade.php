...
<body class="min-h-screen bg-gray-100 dark:bg-gray-800">
    ...
    <div class="container mx-auto px-5">
        <div class="flex justify-between px-2 my-6">
            <h2 class="font-bold text-3xl dark:text-slate-200"><span class="text-green-400 dark:text-green-5500">{{ $patientname }}さん</span>の薬袋</h2>
            <a href="{{ route('padd',['id' => $patient_id ]) }}">
