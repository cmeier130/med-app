...
<div class="flex flex-col mb-6">
    ...
    <div class="container px-4 mx-auto sm:flex sm:justify-center">
        <div class="sm:mx-2 sm:min-w-[782px] p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <a href="{{ route('top') }}" class="mt-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5">
                薬袋へ
